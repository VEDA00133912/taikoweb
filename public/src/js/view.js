			...
			this.nameplateCache.get({
				...
				if (this.multiplayer === 2) {
					...
					if (p2.rank) {
						...
						var rank = { rank_name: strings.account.customrank.p2 }
					}
				}else{
					...
					if(account.loggedIn){
						if(account.rank){
							...
							var rank = { rank_name: strings.account.customrank.no_rank }
						}
					}else{
						var rank = { rank_name: strings.notLoggedIn }
					}
				}
				if (this.controller.autoPlayEnabled) {
					var rank = { rank_name: strings.account.customrank.autoPlaying }
				}
				this.draw.nameplate({
					ctx: ctx,
					x: 3,
					...
					name: name,
					rank: rank,
					auto: this.controller.autoPlayEnabled,
					font: this.font,
					blue: this.player === 2
				})
			})
